...
namespace Sendo.Seller.Client.V5.Api.Dtos.Authentication
{
    /// <summary>
    ...
    public class UserContextDto
    {
        ...
        public List<SendoMenuDto> Menus { get; set; }

        public List<StoreAccessDto> StoreAccess { get; set; }

        public List<StoreFunctionsDto> StoreFunctions { get; set; }
    ...
    public class StoreFunctionsDto
    {
